...
function ProjectCard({ project, isActive, onHover, onLeave }: { 
  ...
  return (
    <div className="w-screen h-screen flex flex-col justify-center items-center relative group shrink-0 border-r border-current/10 bg-[var(--color-dark)]">
      ...
      <div 
        className="relative w-[90vw] md:w-[800px] aspect-video overflow-hidden bg-gray-900 border border-current/10 transition-all duration-500 z-10 shadow-[0_20px_50px_rgba(0,0,0,0.3)] group-hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)] group-hover:scale-[1.02]"
