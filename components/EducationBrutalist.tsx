...
export default function EducationBrutalist() {
  return (
    <section className="py-16 md:py-32 px-6 md:px-20 border-b border-current/10 bg-[var(--color-dark)] text-[var(--color-text)] transition-colors duration-500">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 md:gap-20">
        <div className="md:w-1/3">
          <h3 className="font-display text-4xl md:text-6xl uppercase leading-[0.8] relative md:sticky md:top-32 mb-8 md:mb-0">
          ...
          {EDUCATION.map((edu) => (
            <div key={edu.id} className="group relative pl-8 border-l border-current/20 hover:border-neon-readable transition-colors duration-300">
              ...
              <div className="flex justify-between items-baseline mb-2 flex-wrap gap-2">
                <h4 className="font-display text-2xl md:text-3xl uppercase">{edu.title}</h4>
